document.addEventListener('DOMContentLoaded',()=>{
  ...
  style.textContent=`
    ...
    .site-server-link{position:fixed;z-index:10000;top:18px;right:360px;display:inline-flex;align-items:center;justify-content:center;gap:9px;width:154px;min-height:44px;padding:0 16px;border:1px solid #8f6c3c;border-radius:8px;background:#6f542d;color:#fff!important;font-size:.76rem;font-weight:900;letter-spacing:.08em;text-transform:uppercase;box-shadow:0 8px 28px rgba(0,0,0,.38);transition:transform .15s ease,background .15s ease}.site-server-link:hover{transform:translateY(-2px);background:#816238}.site-store-link{position:fixed;z-index:10000;top:18px;right:190px;display:inline-flex;align-items:center;justify-content:center;gap:9px;width:154px;min-height:44px;padding:0 16px;border:1px solid #e17a3a;border-radius:8px;background:#c9672d;color:#fff!important;font-size:.76rem;font-weight:900;letter-spacing:.08em;text-transform:uppercase;box-shadow:0 8px 28px rgba(0,0,0,.38);transition:transform .15s ease,background .15s ease}.site-store-link:hover{transform:translateY(-2px);background:#db7334}.site-store-link .store-flame{width:20px;height:22px;display:inline-flex;align-items:center}.site-store-link .store-flame svg{width:20px;height:22px;fill:currentColor}.site-discord-link{position:fixed;z-index:10000;top:18px;right:20px;display:inline-flex;align-items:center;gap:9px;width:154px;min-height:44px;padding:0 16px;border:1px solid #7b83ff;border-radius:8px;background:#5865F2;color:#fff!important;font-size:.76rem;font-weight:900;letter-spacing:.08em;text-transform:uppercase;box-shadow:0 8px 28px rgba(0,0,0,.38);transition:transform .15s ease,background .15s ease}
    ...
    @media(max-width:760px){.site-server-link{top:12px;right:268px;width:112px;min-height:40px;padding:0 8px;font-size:.58rem}.site-store-link{top:12px;right:140px;width:112px;min-height:40px;padding:0 8px;font-size:.6rem}.site-discord-link{top:12px;right:12px;width:112px;min-height:40px;padding:0 8px;font-size:.6rem}.site-discord-link svg{width:19px;height:19px}}
  `;
