document.addEventListener('DOMContentLoaded',()=>{
  ...
  if(!document.querySelector('.site-server-link')){
    ...
    a.className='site-server-link'+(isNamalsk?' namalsk':'');
