document.addEventListener('DOMContentLoaded',()=>{
  ...
  if(document.body.classList.contains('home-page')||document.querySelector('.world-tag:not(.frozen)')){
    ...
    const leftWindStyle=document.createElement('style');leftWindStyle.textContent='@keyframes ember-float{0%{transform:translateY(0) scale(.55);margin-left:0;opacity:0}14%{opacity:.9}38%{transform:translateY(-34vh) scale(1.05);margin-left:-12px}64%{transform:translateY(-66vh) scale(.92);margin-left:-29px}84%{transform:translateY(-91vh) scale(1.05);margin-left:-43px}100%{transform:translateY(-110vh) scale(.8);margin-left:-58px;opacity:0}}';document.head.appendChild(leftWindStyle);
    const strongWindStyle=document.createElement('style');strongWindStyle.textContent='@keyframes ember-float{0%{transform:translateY(0) scale(.55);margin-left:0;opacity:0}14%{opacity:.9}38%{transform:translateY(-34vh) scale(1.05);margin-left:-30px}64%{transform:translateY(-66vh) scale(.92);margin-left:-72px}84%{transform:translateY(-91vh) scale(1.05);margin-left:-108px}100%{transform:translateY(-110vh) scale(.8);margin-left:-145px;opacity:0}}';document.head.appendChild(strongWindStyle);
