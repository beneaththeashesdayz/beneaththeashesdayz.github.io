document.addEventListener('DOMContentLoaded',()=>{
  ...
  document.querySelectorAll('.launcher-select').forEach(select=>select.addEventListener('change',()=>{const urls={steam:'steam://run/221100',dzsa:'https://dayzsalauncher.com/',beans:'https://dayzbeanslauncher.com/'};const url=urls[select.value];if(url){window.location.href=url}}));
